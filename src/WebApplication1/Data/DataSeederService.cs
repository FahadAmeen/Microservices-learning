...
namespace WebApplication1.API.Data
{
    public class DataSeederService:IDataSeeder
    {
        ...
        public DataSeederService(CatalogContext context)
        {
            _dbContext = context;
        }
        ...
        {
            if (await _dbContext.Products.CountAsync() == 0)
            {
                _dbContext.Products.AddRange(ProductsDataList);
            }

            await _dbContext.SaveChangesAsync();
        }

        private List<Product> ProductsDataList =>
            new List<Product>()
            {
                new Product()
                {
